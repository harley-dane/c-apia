    ...
    <div className="container mx-auto py-8">
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="max-w-lg mx-auto p-4">
        ...
        <div className="mb-4">
          ...
          <input type="text" {...register('skills')} className="w-full p-2 border" placeholder="e.g., Teaching, Planting" />
        </div>
        <div className="mb-4">
          <label className="block mb-2">{t('message')}</label>
          <textarea {...register('message')} className="w-full p-2 border"></textarea>
        </div>
